...
public class OperacoesBanco extends JInternalFrame {
	...
	*/
		...
		btnSaque.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Double.parseDouble(JOptionPane.showInputDialog(null, "Digite o valor para saque. (formato x00.00)", "Saque em conta bancária", JOptionPane.QUESTION_MESSAGE));
	...
	/**
	* Método responsável por adicionar evento ao botão deposito, este que chamará um JOptionPane
	...
	*/
	...
	/**
	* Método responsável por Atualizar dados da tabela de transaões sempre que alguma transação e
