...
public class AppController extends HttpServlet {
	...
	/**public void gerarLog(final String descricao){
		...
		// verifica se essa lista de logs esta vazia se estiver ela � e inicializada com
		...
		//coloca a lista de logs anteriores como o novo log gerado na sess�o novamente.		
